...
%	 \newcommand{\del}[1]{\textcolor{red}{\sout{#1}}} % please delete
%	 \newcommand{\chg}[2]{\textcolor{red}{\sout{#1}}{\ra}\textcolor{blue}{\uline{#2}}} % please change
	 \newcommand{\chk}[1]{\nb{CHECK}{magenta}{#1}} % changed, please check
	}
{\newcommand{\nb}[3]{}
  \newcommand{\version}{}
...
\newcommand{\subsubsecref}[1]{\hyperref[{subsubsec:#1}]{Subsubsection~\ref*{subsubsec:#1}}}
...
\newcommand{\stacktraceref}[1]{\hyperref[{stacktrace:#1}]{Stack trace~\ref*{stacktrace:#1}}}
\newcommand{\listref}[1]{\hyperref[{list:#1}]{List~\ref*{list:#1}}}
...
\newcommand{\thesisasst}{Nevena Milojkovi\'{c}, Boris Spasojevi\'{c}}
\newcommand{\thesisurl}{http://scg.unibe.ch/}
\newcommand{\thesissubtitle}{Where does this null come from? An approach to pinpoint the origin location of a null reference}
\newcommand{\thesisdate}{20. December 2016}
...
% usefull shortcuts
\newcommand{\npe}{null pointer exception\xspace}
\newcommand{\npes}{null pointer exceptions\xspace}
\newcommand{\rte}{run-time exception\xspace}
\newcommand{\Rte}{Run-time exception\xspace}
\newcommand{\Npe}{Null pointer exception\xspace}
\newcommand{\Npes}{Null pointer exceptions\xspace}
\newcommand{\NpE}{Null Pointer Exception\xspace}
\newcommand{\mr}{method receiver\xspace}
\newcommand{\mrs}{method receivers\xspace}
\newcommand{\Mr}{Method receiver\xspace}
\newcommand{\Mrs}{Method receivers\xspace}
\newcommand{\MR}{Method Receiver\xspace}
\newcommand{\MRs}{Method Receivers\xspace}
\newcommand{\tblock}{try-block\xspace}
\newcommand{\cblock}{catch-block\xspace}
\newcommand{\tcblock}{try-catch-block\xspace}
