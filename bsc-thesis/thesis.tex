...
Important integers like the line number and pcs are added to the bytecode sequence from line 31 to 24.

Finally all classes that the check-method takes as parameter are prepared at lines 36 to 39 and the instruction \textit{``invokestatic''} is added to the bytecode.  
