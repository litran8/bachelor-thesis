...
With a syntactic example \coderef{fieldExample} we show how the instructions \textit{``putfield''} and \textit{``putstatic''} are used:
...
\lt{enter code byteceode construction}
